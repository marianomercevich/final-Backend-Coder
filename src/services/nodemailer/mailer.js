...
export const sendEmailPurchase = async (userEmail, ticket) => {
  ...
  let content = {
    body: {
      ...
      intro: "Tu orden ha sido prosesada con exito!",
      dictionary: {
...
export const sendEmailRegister = async (userEmail) => {
  ...
  let content = {
    body: {
      ...
      intro: `bienvenido!  gracias por registrarte en esta comunidad! ${userEmail.email}`,
      outro: `pudes ingresar en la app para relalizar tus compras! ${userEmail.role}`,
      signature: false,
    },
  };
